const PROJECTS = {
  'food-scanner': {
    title: 'Food Scanner',
    titleZh: '反正你還是會吃',
    cover: 'images/foodscanner_cover.jpg',
    ...
    content: [
      { type: 'image', src: 'images/foodscanner_cover.jpg' },
      { type: 'image', src: 'images/foodscanner_1.jpg' },
      { type: 'image', src: 'images/foodscanner_2.jpg' },
      { type: 'image', src: 'images/foodscanner_3.jpg' },
      { type: 'image', src: 'images/foodscanner_4.jpg' },
      ...
      { type: 'image', src: 'images/foodscanner_6.jpg' },
      { type: 'image', src: 'images/foodscanner_7.jpg' },
  ...
  'between-faces': {
    ...
    cover: 'images/betweenfaces_cover.jpg',
    ...
    content: [
      { type: 'image', src: 'images/betweenfaces_1.jpg' },
      { type: 'details', items: [
        {
      ...
      { type: 'image', src: 'images/betweenfaces_3.jpg' },
      { type: 'image', src: 'images/betweenfaces_4.jpg' },
      { type: 'image', src: 'images/betweenfaces_5.jpg' },
      { type: 'image', src: 'images/betweenfaces_7.jpg' },
      ...
      { type: 'image', src: 'images/betweenfaces_8.jpg' },
      { type: 'credits', items: [
  ...
  'underneath': {
    title: 'Underneath',
    titleZh: '',
    cover: 'images/underneath_cover.jpg',
    ...
    content: [
      { type: 'image', src: 'images/underneath_cover.jpg' },
      { type: 'details', items: [
        {
          label: 'About story',
      ...
      { type: 'image', src: 'images/underneath_1.jpg' },
      { 
        type: 'details', items: [
          {
      ...
      { type: 'image', src: 'images/underneath_2.jpg' },
      { type: 'image', src: 'images/underneath_3.jpg' },
      { type: 'image', src: 'images/underneath_4.jpg' },
      { type: 'image', src: 'images/underneath_5.jpg' },
      { type: 'image', src: 'images/underneath_6.jpg' },
  ...
  'shape-of-sound': {
    ...
    content: [
      { type: 'image', src: 'images/sound_1.jpg' },
      { type: 'image', src: 'images/sound_2.jpg' },
      { type: 'image', src: 'images/sound_3.jpg' },
      { type: 'image', src: 'images/sound_4.jpg' },
